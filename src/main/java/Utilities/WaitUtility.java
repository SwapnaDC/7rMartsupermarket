...
public class WaitUtility 
{
	...
	public static void waitForTitle(WebDriver driver, String target)
	{
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(EXPLICIT_WAIT));
		wait.until(ExpectedConditions.titleContains(target));
	}
	public static void waitForTitleIs(WebDriver driver,String target)
	{
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(EXPLICIT_WAIT));
...
public static void fluentWaitForElements(WebDriver driver,WebElement target) {
