...
//	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/list-payment-methods?edit=2&page_ad=1']")WebElement editbutton;
	...
	@FindBy(xpath="//td[text()='debit']")WebElement gettextfromthepage;
	...
	public boolean updatedalertmessagefieldisDisplayed()
	{
		return PageUtility.isElementDisplayed(updatedalertmessage);
	}
	...
	public boolean alertmessagefieldisDisplayed()
	{
		return PageUtility.isElementDisplayed(alertget);
	}
	...
	public boolean textareisDisplayed()
	{
		return PageUtility.isElementDisplayed(text);
	}
	...
	public boolean buttenisenabled()
	{
		...
		return PageUtility.isElementEnabled(newsbuttonnew);
	}
	...
	{
		return PageUtility.isElementDisplayed(getalertmessage);
	}
